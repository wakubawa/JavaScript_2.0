...
function f5() {
    if (document.querySelector('.i-5').checked) {
        document.querySelector('div.out-5').innerHTML = document.querySelector('.i-5').value;
    }
    else {
...
function f6() {
    document.querySelector('div.out-6').innerHTML = document.querySelector('.i-6').value;     
}
...
function f7() {
    let pas_i7 = document.querySelector('.i-7').value;
    document.querySelector('.out-71').innerHTML = pas_i7;
    if (pas_i7.length >= 6){
...
function f8() {
    document.querySelector('.out-8').innerHTML = '<input type="text" class="i-81"></div> <button class="button-primary b-81">Task-8</button>';
