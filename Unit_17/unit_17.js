...
function t2() {
    a2_res = a2.map(elem => { return elem*elem});
    return a2_res;
}
...
function t3() {
    a3_res = a3.map(elem => {if (typeof(elem) == 'number'){return elem} else {return Number(elem)}});
    return a3_res;
}
...
function t4() {
    a4_res = a4.map(elem => {if (typeof(elem) == 'number'){return elem}});
    a4_res = a4_res.filter(elem => elem !== undefined);
    return a4_res;
}
