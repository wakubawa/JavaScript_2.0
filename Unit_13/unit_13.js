...
function f3() {
    ...
    let out = '';
    for (let key in a3){
        if (a3[key] === 'hi') out += key + '----' + a3[key] + '<br>';
    }
    return out;
    // return
}
...
function f6() {
    a6[document.querySelector('.i-61').value] = document.querySelector('.i-62').value;
    f5(a6, '.out-6');
}
...
function f7() {
    let out = 0;
    let input_i_7 = document.querySelector('.i-7').value;
    for (let key in a7){
        if (key == input_i_7) out = 1;
    }
...
function f8() {
    let out = '';
    let input_i_8 = document.querySelector('.i-8').value;
    for (let key in a8){
        if (key === input_i_8) out += a8[key] + ' ';
    }
...
function f9() {
    let out = '';
    let input_i_9 = document.querySelector('.i-9').value;
    for (let key in a9){
        if (String(a9[key]) === input_i_9) out += key + '--' + a9[key] + '<br>';
    }
...
function f12() {
    let input_i_12 = document.querySelector('.i-12').value;
    let out = '';
    for ( let key in a12){
        if (String(a12[key]) === input_i_12){
             delete a12[key];
        } else {
            out += key + '--' + a12[key] + '<br>';
        }
...
function f18() {
    let out = '';
    let input_i_18 = document.querySelector('.i-18').value;
    for (let key in a18){
        if (key === input_i_18) {
            for (let jey in a18[key]){
                out += a18[key][jey] + ' ';
            }
        }
    }
...
function f19() {
    let out = '';
    let input_i_19 = document.querySelector('.i-19').value;
    for (let key in a19){
        for (let jey in a19[key]){
            if (a19[key][jey].toLowerCase() === input_i_19.toLowerCase()) out = key;
        }
    }
...
function f20() {
    let out = '';
    for (let key in a20){
        for (let jey in a20[key]){
            if (a20[key][jey][1] === 2) out += a20[key][jey][0] + '___';
        }
    }
