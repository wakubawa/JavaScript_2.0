...
let out_11 = '';
function f11() {
    out_11 = d11.indexOf(Number(document.querySelector('.i-11').value));
...
function f12() {
    let i_12 = Number(document.querySelector('.i-12').value);
    document.querySelector('.out-12').textContent = -1;
    console.log(document.querySelector('.out-12').textContent);
...
function f14() {
    let d14 = [];    
    for(let i=0; i < document.querySelector('.i-14').value; i++){
        d14[i] = 1;
    };
    showArr('.out-14', d14);
}
...
function f15() {
    if (d15.indexOf(document.querySelector('.i-15').value) === -1)
        d15.push(document.querySelector('.i-15').value);
